  ...
  return (
    <section className="w-full bg-white py-6 mt-5 ">
      <div className="max-w-8xl mb-20  mx-auto px-4">
        ...
        <div className="flex gap-3 sm:gap-6 overflow-x-auto pb-2 scrollbar-hide snap-x snap-mandatory">
          {items.map((item, index) => (
            <div
              key={index}
              className="watch-card flex-shrink-0 w-32 sm:w-64 rounded-xl bg-white shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden snap-start"
            >
              <div
