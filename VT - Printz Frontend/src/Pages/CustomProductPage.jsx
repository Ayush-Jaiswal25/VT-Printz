...
import { servicesData } from '../data/ServiceData'; // Assuming data comes from here

const CustomProductPage = () => {
  const { categorySlug, serviceSlug, subSlug } = useParams();
  const navigate = useNavigate();

  // Find the correct product/service based on slugs
  const category = servicesData.find(c => c.categorySlug === categorySlug);
